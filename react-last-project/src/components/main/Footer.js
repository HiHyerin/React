    ...
    return(
        ...
        <div className="bgded overlay row4" style={{"backgroundImage":"url('images/demo/backgrounds/01.png')"}}>
            <footer id="footer" className="hoc clear" >
                ...
                <div className="one_third first">
                    <h6 className="heading" style={{"fontFamily":"TheJamsil5Bold","fontSize":"20px"}}>오늘의 뉴스</h6>
                ...
                <div className="one_third">
                    <h6 className="heading" style={{"fontFamily":"TheJamsil5Bold","fontSize":"20px"}}>오늘의 제주 맛집 Top9</h6>
                ...
                <div className="one_third">
                    <h6 className="heading" style={{"fontFamily":"TheJamsil5Bold","fontSize":"20px"}}>오늘의 레시피 Top9</h6>
                    <ul className="nospace clear latestimg">
                        <li><a className="imgover" href="#"><img src="images/demo/100x100.png" alt=""/></a></li>
                        <li><a className="imgover" href="#"><img src="images/demo/100x100.png" alt=""/></a></li>
                        <li><a className="imgover" href="#"><img src="images/demo/100x100.png" alt=""/></a></li>
        ...
        <div className="wrapper row5">
            <div id="copyright" className="hoc clear">
                <p className="fl_left">Copyright &copy; 2023-03-23 - Gangnam SsangYong Education - <a href="#">송혜린</a></p>
                <p className="fl_right"><a  href="https://github.com/HiHyerin">Git Address</a></p>
            </div>
        </div>
        </Fragment>
    )
