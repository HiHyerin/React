...
import {NavLink} from "react-router-dom"; // use들 : hooks
    ...
    return (
        <div className={"row"}>
            ...
            <table className="table">
                <tbody>
                <tr>
                    <td width="20%" className="text-center" colSpan="2"><h3 style={{"display":"inline","float":"left"}}>{foodDetail.name}</h3>&nbsp;<h3 style={{"color":"orange","display":"inline","float":"left"}}>{foodDetail.score}</h3></td>
            </tr>
            <tr>
